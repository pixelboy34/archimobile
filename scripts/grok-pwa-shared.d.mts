...
export declare function siteHexColor(value: unknown, fallback?: string): string;
export declare function resolveAppDisplayName(
  hostHeader: string | null | undefined,
  site?: OgSite,
): string;
export declare function pwaIconEntries(cwd?: string): Array<{
  src: string;
  sizes: string;
  type: string;
}>;
