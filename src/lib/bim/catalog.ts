...
export const OBJECT_CATALOG: ObjectDef[] = [
  ...
  { kind: "cornersofa", label: FURNITURE_LABELS.cornersofa, group: "living", w: 2.6, d: 2.0, h: 0.78, style: "sofa", mat: "wood" },
  { kind: "loveseat", label: FURNITURE_LABELS.loveseat, group: "living", w: 1.6, d: 0.9, h: 0.78, style: "sofa", mat: "wood" },
  { kind: "tvbench", label: FURNITURE_LABELS.tvbench, group: "living", w: 1.8, d: 0.4, h: 0.45, style: "cabinet", mat: "darkwood" },
  { kind: "speaker", label: FURNITURE_LABELS.speaker, group: "living", w: 0.28, d: 0.32, h: 0.9, style: "box", mat: "darkwood" },
  { kind: "artwork", label: FURNITURE_LABELS.artwork, group: "living", w: 1.2, d: 0.04, h: 0.9, style: "panel", mat: "white" },
  { kind: "roundtable", label: FURNITURE_LABELS.roundtable, group: "dining", w: 1.2, d: 1.2, h: 0.75, style: "table", mat: "wood" },
  { kind: "stool", label: FURNITURE_LABELS.stool, group: "dining", w: 0.38, d: 0.38, h: 0.75, style: "chair", mat: "wood" },
  { kind: "hightable", label: FURNITURE_LABELS.hightable, group: "dining", w: 1.4, d: 0.7, h: 1.1, style: "table", mat: "darkwood" },
  { kind: "bunk", label: FURNITURE_LABELS.bunk, group: "sleep", w: 0.9, d: 2.0, h: 1.7, style: "bed", mat: "wood" },
  { kind: "mirror", label: FURNITURE_LABELS.mirror, group: "sleep", w: 0.7, d: 0.04, h: 1.4, style: "panel", mat: "glass" },
  { kind: "pantry", label: FURNITURE_LABELS.pantry, group: "cook", w: 0.6, d: 0.6, h: 2.1, style: "cabinet", mat: "white" },
  { kind: "winefridge", label: FURNITURE_LABELS.winefridge, group: "cook", w: 0.6, d: 0.6, h: 1.8, style: "appliance", mat: "metal" },
  { kind: "trashbin", label: FURNITURE_LABELS.trashbin, group: "cook", w: 0.4, d: 0.4, h: 0.7, style: "box", mat: "metal" },
  { kind: "towelrail", label: FURNITURE_LABELS.towelrail, group: "wet", w: 0.5, d: 0.12, h: 1.2, style: "panel", mat: "metal" },
  { kind: "wcwall", label: FURNITURE_LABELS.wcwall, group: "wet", w: 0.4, d: 0.55, h: 0.85, style: "sanitary", mat: "white" },
  { kind: "doublebasin", label: FURNITURE_LABELS.doublebasin, group: "wet", w: 1.2, d: 0.48, h: 0.85, style: "sanitary", mat: "white" },
  { kind: "meeting", label: FURNITURE_LABELS.meeting, group: "work", w: 2.4, d: 1.2, h: 0.75, style: "table", mat: "darkwood" },
  { kind: "reception", label: FURNITURE_LABELS.reception, group: "work", w: 2.0, d: 0.7, h: 1.1, style: "cabinet", mat: "wood" },
  { kind: "locker", label: FURNITURE_LABELS.locker, group: "work", w: 0.4, d: 0.5, h: 1.8, style: "cabinet", mat: "metal" },
  { kind: "vmc", label: FURNITURE_LABELS.vmc, group: "tech", w: 0.6, d: 0.4, h: 0.35, style: "box", mat: "metal" },
  { kind: "panelboard", label: FURNITURE_LABELS.panelboard, group: "tech", w: 0.4, d: 0.18, h: 0.8, style: "panel", mat: "white" },
  { kind: "boiler", label: FURNITURE_LABELS.boiler, group: "tech", w: 0.5, d: 0.4, h: 0.7, style: "appliance", mat: "white" },
  { kind: "heatpump", label: FURNITURE_LABELS.heatpump, group: "tech", w: 0.9, d: 0.35, h: 0.7, style: "appliance", mat: "white", site: true },
  { kind: "tank", label: FURNITURE_LABELS.tank, group: "tech", w: 0.55, d: 0.55, h: 1.6, style: "post", mat: "white" },
  { kind: "ramp", label: FURNITURE_LABELS.ramp, group: "core", w: 1.2, d: 4.0, h: 0.15, style: "box", mat: "concrete" },
  { kind: "railing", label: FURNITURE_LABELS.railing, group: "core", w: 2.0, d: 0.06, h: 1.1, style: "fence", mat: "metal" },
  { kind: "canopy", label: FURNITURE_LABELS.canopy, group: "garden", w: 3.0, d: 1.2, h: 2.4, style: "pergola", mat: "metal", site: true },
  { kind: "deck", label: FURNITURE_LABELS.deck, group: "garden", w: 4.0, d: 3.0, h: 0.12, style: "rug", mat: "wood", site: true },
  { kind: "claustra", label: FURNITURE_LABELS.claustra, group: "garden", w: 2.4, d: 0.08, h: 1.8, style: "panel", mat: "wood", site: true },
  { kind: "compost", label: FURNITURE_LABELS.compost, group: "garden", w: 0.8, d: 0.8, h: 0.9, style: "box", mat: "wood", site: true },
  { kind: "bikeshade", label: FURNITURE_LABELS.bikeshade, group: "garden", w: 2.4, d: 1.2, h: 2.2, style: "pergola", mat: "metal", site: true },
  { kind: "dumpster", label: FURNITURE_LABELS.dumpster, group: "site", w: 1.8, d: 1.2, h: 1.4, style: "box", mat: "metal", site: true },
